          ...
          Stack(
            ...
            children: [
              Container(
                  ...
                  decoration:
                      BoxDecoration(color: Color.fromARGB(255, 210, 81, 81)),
                  child: Column(
                    children: [
                      Row(
                        children: [
                ...
                child: Container(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 224, 66, 66),
                              ...
                              Expanded(
                                  child: ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        primary:
                                            Color.fromARGB(255, 237, 235, 253),
                            ...
                            children: [
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Ricw Bowl Wtih Chicken Teriyaki Mushroom",
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontFamily: 'Roboto',
                                          fontWeight: FontWeight.bold),
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  "See all",
                  style: TextStyle(
                      color: const Color.fromRGBO(75, 255, 255, 255),
                      fontSize: 17,
                      fontFamily: 'Roboto',
                      fontWeight: FontWeight.w600),
                ),
